<script>
    ...
    import Loginmodal from "../loginmodal/login.svelte"
	...
	<div class="navbartopper">
		<div class="container navbar">
			<div class="navbar top-left">
				<!--ซ้าย-->
				<ul>
					<li><a href="/Profile">Seller Centre |</a></li>
					<li><a href="/">ขายสินค้ากับช้อปปี้ |</a></li>
			...
			<div class="navbar top-right">
				...
				<ul>
					...
					<li><a href="./Register">สมัครใหม่</a></li>
					<Loginmodal />
				</ul>
			</div>
		</div>
